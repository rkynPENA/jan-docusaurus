...
:::
        ...
        For MacOS, the download should be available as a `.dmg`.
...
:::
        ...
        For stable releases, go to [jan.ai](https://jan.ai/).
        For Windows, the download should be available as a `.exe` file.
...
:::
        ...
        For stable releases, go to [jan.ai](https://jan.ai/).
        For Linux, the download should be available as a `.AppImage` file or a `.deb` file.
